...
window.addEventListener('load',(e)=>{
    ...
    const id=parseInt(parameters.searchParams.get('id'));
    
   
    if (id===undefined){
          return window.location.href='index_admin.html'
    }
	...
	//establezco las configuraciones para el envío
        ...
        .then(respuesta =>{
            ...
            try {
                ...
                imgActual.setAttribute('src',`https://Kike8789.pythonanywhere.com/static/img/products/${respuesta.data['img']}`)
